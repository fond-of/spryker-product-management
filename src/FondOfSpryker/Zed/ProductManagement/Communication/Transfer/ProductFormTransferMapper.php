...
{
    /**
     * @var array|\FondOfSpryker\Zed\ProductManagement\Dependency\Plugin\ProductAbstractFormTransferMapperExpanderPluginInterface[]
     */
    protected $productAbstractFormTransferMapperExpanderPlugins;
     ...
     * @param \FondOfSpryker\Zed\ProductManagement\Dependency\Plugin\ProductAbstractFormTransferMapperExpanderPluginInterface[] $productAbstractFormTransferMapperExpanderPlugins
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            $localeFacade,
            $localeProvider,
            $productFormTransferMapperExpanderPlugins,
